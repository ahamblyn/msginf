...
public class RequestReplyConnectionPanel extends JPanel {
	...
	private String[] validRequesterClassNames = new String[]{"nz.co.pukeko.msginf.client.connector.ConsumerMessageRequester", "nz.co.pukeko.msginf.client.connector.FutureResultsHandlerMessageRequester"};
