...
public class QueueStatistics {
	...
	public Hashtable<Long, Integer> getHistogramData() {
		Hashtable<Long, Integer> res = new Hashtable<Long, Integer>();
		SortedSet<Long> ss = new TreeSet<Long>(messageTimes);
        for (Long value : ss) {
	...
	public String toString() {
		...
		sb.append("\nMessages Sent:                 " + getMessageCount());
		sb.append("\nFailed Messages:               " + getFailedMessageCount());
		sb.append("\nAverage Time Per Message (ms): " + getAverageTimePerMessage());
		sb.append("\nMedian Time Per Message (ms):  " + getMedianMessageTime());
		sb.append("\nMax Message Time (ms):         " + getMaxMessageTime());
		sb.append("\nMin Message Time (ms):         " + getMinMessageTime());
		return sb.toString();
	}
}
