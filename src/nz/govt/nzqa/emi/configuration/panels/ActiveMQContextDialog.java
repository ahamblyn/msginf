...
import nz.govt.nzqa.emi.configuration.model.QueueTableModel;
...
public class ActiveMQContextDialog extends JDialog {
	...
	private JTable queueTable = new JTable();
	private JScrollPane tableScrollPane = new JScrollPane(queueTable);
	private JButton add = new JButton("Add");
	private JButton remove = new JButton("Remove");
	private JButton ok = new JButton("OK");
	private QueueTableModel model;
	private ListSelectionModel queueTableListSelectionModel;
	...
	private void initTable() {
	    ...
	    queueTable.doLayout();
	    queueTableListSelectionModel = queueTable.getSelectionModel();
