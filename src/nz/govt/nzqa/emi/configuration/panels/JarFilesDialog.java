...
import nz.govt.nzqa.emi.configuration.model.JarFilesTableModel;
import nz.govt.nzqa.emi.infrastructure.util.swing.JarFileFilter;
...
public class JarFilesDialog extends JDialog {
	...
	private JTable jarFilesTable = new JTable();
	private JScrollPane tableScrollPane = new JScrollPane(jarFilesTable);
	private JButton browse = new JButton("Browse");
	private JButton remove = new JButton("Remove");
	private JButton ok = new JButton("OK");
	private JarFilesTableModel model;
	private ListSelectionModel jarFilesTableListSelectionModel;
	...
	private void initTable() {
		...
		jarFilesTableListSelectionModel = jarFilesTable.getSelectionModel();
	...
	public String[] getJarFilesTableData() {
		if (model != null) {
			return (String[])model.getAllData();
		} else {
			return null;
		}
	}
