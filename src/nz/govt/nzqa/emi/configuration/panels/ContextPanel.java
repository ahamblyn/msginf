...
public class ContextPanel extends JPanel {
	private JLabel initialContextFactoryLabel = new JLabel("Initial Context Factory:");
	private JTextField initialContextFactory = new JTextField(20);
	...
	private JLabel namingFactoryURLPkgsLabel = new JLabel("Naming Factory URL Pkgs:");
	private JTextField namingFactoryURLPkgs = new JTextField(20);
	...
	private void init() {
	    ...
	    titledBorder = new TitledBorder(border, "Context");
	...
	class ContextPanel_DocumentFilter extends DocumentFilter {
