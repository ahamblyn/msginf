package nz.govt.nzqa.emi.configuration;
...
import nz.govt.nzqa.emi.configuration.panels.AboutDialog;
import nz.govt.nzqa.emi.configuration.panels.ConfigPanel;
import nz.govt.nzqa.emi.configuration.panels.LogPanel;
...
import nz.govt.nzqa.emi.infrastructure.util.swing.XMLFileFilter;
...
public class ConfigurationApplication {
	...
	private JTabbedPane messagingSystemsPane = new JTabbedPane();
	private LogPanel log4jPanel = new LogPanel();
	private JPanel buttonPanel = new JPanel();
	private JButton addNewMessagingSystem = new JButton("Add New Messaging System");
	private JButton removeMessagingSystem = new JButton("Remove Messaging System");
	...
	private void addNewMessagingSystem_actionPerformed() {
		String newMessagingSystemName = (String)JOptionPane.showInputDialog(frame, "Please enter the name of the new messaging system.", "New Messaging System", JOptionPane.PLAIN_MESSAGE);
