...
public class TestMessageInfrastructurePropertiesFileParser {
    ...
    public void validActiveMQMessagingSystem() {
        ...
        try {
            ...
            Assertions.assertEquals(messagingSystem, parser.getSystem(messagingSystem).orElseThrow().getName());
    ...
    public void messageFileSystemProperty() {
        ...
        try {
            ...
            Assertions.assertEquals(messagingSystem, tempFileParser.getSystem(messagingSystem).orElseThrow().getName());
    ...
    public void messageRequestTypeSubmit() {
        ...
        Assertions.assertEquals(MessageType.TEXT, parser.getMessageType("rabbitmq", "submit_text", MessageRequestType.SUBMIT));
        Assertions.assertEquals(MessageType.BINARY, parser.getMessageType("rabbitmq", "submit_binary", MessageRequestType.SUBMIT));
    }
    ...
    public void messageRequestTypeRequestResponse() {
        ...
        Assertions.assertEquals(MessageType.TEXT, parser.getMessageType("rabbitmq", "text_request_text_reply", MessageRequestType.REQUEST_RESPONSE));
        Assertions.assertEquals(MessageType.BINARY, parser.getMessageType("rabbitmq", "binary_request_text_reply", MessageRequestType.REQUEST_RESPONSE));
    }
