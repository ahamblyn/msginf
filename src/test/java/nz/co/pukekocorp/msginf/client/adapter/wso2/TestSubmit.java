package nz.co.pukekocorp.msginf.client.adapter.wso2;
...
public class TestSubmit {
    ...
    @AfterEach
    public void sleep() {
        // Sleep so messages finish processing between tests
    ...
    public void submitTextMessages() throws MessageException {
        for (int i = 0; i < 10; i++) {
            MessageResponse response = messenger.sendMessage("wso2", TestUtil.createTextMessageRequest(MessageRequestType.SUBMIT,
    ...
    public void receiveTextMessages() throws MessageException {
        List<MessageResponse> messages = messenger.receiveMessages("wso2", "submit_text", 2000);
    ...
    @Test
    @Order(4)
    public void receiveTextMessagesThreads() throws MessageException {
        List<MessageResponse> messages = messenger.receiveMessages("wso2", "submit_text", 2000);
        assertNotNull(messages);
    ...
    @Test
    @Order(6)
    public void receiveTextMessagesAsync() throws MessageException {
        List<MessageResponse> messages = messenger.receiveMessages("wso2", "submit_text", 2000);
        assertNotNull(messages);
    ...
    public void submitBinaryMessages() throws Exception {
        for (int i = 0; i < 10; i++) {
            MessageResponse response = messenger.sendMessage("wso2", TestUtil.createBinaryMessageRequest(MessageRequestType.SUBMIT,
    ...
    public void receiveBinaryMessages() throws MessageException {
        List<MessageResponse> messages = messenger.receiveMessages("wso2", "submit_binary", 2000);
        assertNotNull(messages);
        assertEquals(10, messages.size());
        log.info(QueueStatisticsCollector.getInstance().toString());
    }
    ...
    @Test
    @Order(10)
    public void receiveBinaryMessagesThreads() throws MessageException {
        List<MessageResponse> messages = messenger.receiveMessages("wso2", "submit_binary", 2000);
        assertNotNull(messages);
        assertEquals(50, messages.size());
        log.info(QueueStatisticsCollector.getInstance().toString());
    ...
    @Test
    @Order(12)
    public void receiveBinaryMessagesAsync() throws MessageException {
        List<MessageResponse> messages = messenger.receiveMessages("wso2", "submit_binary", 2000);
        assertNotNull(messages);
        assertEquals(20, messages.size());
        log.info(QueueStatisticsCollector.getInstance().toString());
