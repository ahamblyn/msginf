package nz.co.pukekocorp.msginf.client.adapter.artemis;
...
public class TestSubmit {
    ...
    public void submitTextMessages() throws MessageException {
        for (int i = 0; i < 10; i++) {
            MessageResponse response = messenger.sendMessage("artemis", TestUtil.createTextMessageRequest(MessageRequestType.SUBMIT,
    ...
    public void receiveTextMessages() throws MessageException {
        List<MessageResponse> messages = messenger.receiveMessages("artemis", "submit_text", 2000);
    ...
    public void submitBinaryMessages() throws Exception {
        for (int i = 0; i < 10; i++) {
            MessageResponse response = messenger.sendMessage("artemis", TestUtil.createBinaryMessageRequest(MessageRequestType.SUBMIT,
    ...
    public void receiveBinaryMessages() throws MessageException {
        List<MessageResponse> messages = messenger.receiveMessages("artemis", "submit_binary", 2000);
        assertNotNull(messages);
        assertEquals(10, messages.size());
        log.info(QueueStatisticsCollector.getInstance().toString());
    }
