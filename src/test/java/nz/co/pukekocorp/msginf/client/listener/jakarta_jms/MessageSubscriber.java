...
public class MessageSubscriber implements MessageListener {
    ...
    public static void main(String[] args) {
        if (args.length != 5) {
            System.out.println("Usage: java nz.co.pukekocorp.msginf.client.listener.jakarta_jms.MessageSubscriber <messaging system> <topic connection factory name> <topic name> <jndi url> <useDurableSubscriber>");
            System.exit(1);
        }
