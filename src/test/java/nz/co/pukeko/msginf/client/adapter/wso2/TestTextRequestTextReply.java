...
public class TestTextRequestTextReply {
    ...
    public static void setUp() {
        try {
            ...
            messageRequestReply = new MessageRequestReply(parser, "wso2",
                    "qpidConnectionfactory", "RequestQueue",
                    "ReplyQueue");
    ...
    public void reply() throws MessageException {
        for (int i = 0; i < 10; i++) {
            MessageResponse response = messenger.sendMessage("wso2", TestUtil.createTextMessageRequest(MessageRequestType.REQUEST_RESPONSE,
