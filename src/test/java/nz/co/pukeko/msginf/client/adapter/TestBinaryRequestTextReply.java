...
public class TestBinaryRequestTextReply {
    ...
    public void replyBinaryMessages() throws Exception {
        for (int i = 0; i < 10; i++) {
            MessageResponse response = messenger.sendMessage("activemq", TestUtil.createBinaryMessageRequest(MessageRequestType.REQUEST_RESPONSE,
                    MessageType.BINARY, "activemq_rr_binary_consumer", "data/905727.pdf"));
    ...
    @Test
    @Order(2)
    public void replyBinaryMessagesThreads() throws Exception {
    ...
    @Test
    @Order(3)
    public void replyBinaryMessagesAsync() {
