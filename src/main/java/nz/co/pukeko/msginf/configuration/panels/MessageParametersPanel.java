...
public class MessageParametersPanel extends JPanel {
	private final String[] validMessageClassNames = new String[]{"javax.jms.BytesMessage", "javax.jms.TextMessage", "javax.jms.ObjectMessage", "javax.jms.StreamMessage", "javax.jms.MapMessage"};
	private final JLabel messageClassNameLabel = new JLabel("Message Class Name:");
	private final JComboBox<String> messageClassName = new JComboBox<>(validMessageClassNames);
	private final JLabel messageTimeToLiveLabel = new JLabel("Message Time To Live:");
	private final JSpinner messageTimeToLive = new JSpinner(new SpinnerNumberModel(0,0,120,20));
	private final JLabel replyWaitTimeLabel = new JLabel("Reply Wait Time:");
	private final JSpinner replyWaitTime = new JSpinner(new SpinnerNumberModel(20,20,120,20));
	...
	public int getMessageTimeToLive() {
		return (Integer) messageTimeToLive.getValue();
	}
	...
	public void setMessageTimeToLive(int time) {
		messageTimeToLive.setValue(time);
	}
	...
	public int getReplyWaitTime() {
		return (Integer) replyWaitTime.getValue();
	}
