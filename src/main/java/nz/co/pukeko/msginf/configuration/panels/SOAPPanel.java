...
public class SOAPPanel extends JPanel {
	...
	private final JTextField sourceName = new JTextField(20);
	private final JLabel destinationNameLabel = new JLabel("Destination Name:");
	private final JTextField destinationName = new JTextField(20);
	private final JCheckBox useSOAPEnvelope = new JCheckBox("Use SOAP Envelope", false);
	 ...
	 * @param title Title
	 * @param requestReply is request-reply
	 */
