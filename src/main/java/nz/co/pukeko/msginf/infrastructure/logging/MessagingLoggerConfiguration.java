   ...
   private static URL logFileURL;
	...
	public MessagingLoggerConfiguration() {
       if (logFileLocation == null) {
    	  ...
    	  } catch (MessageException | URISyntaxException me) {
    		  me.printStackTrace();
		  }
	   }
	}
	...
	private boolean loadFile() {
        ...
        try {
            ...
            if (logFile.exists()) {
    			logFileURL  = logFile.toURI().toURL();
                System.out.println("log4j2 file URL: " + logFileURL);
            	fileOK = true;
            }
		} catch (MalformedURLException | SecurityException mue) {
			mue.printStackTrace();
		}
		return fileOK;
	}
	...
	public static void configure() {
		if (ml == null) {
			ml = new MessagingLoggerConfiguration();
		}
	}
}
