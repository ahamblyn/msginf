...
public class MessageDialog extends JDialog {
	...
	private final JButton view = new JButton("View Header");
	...
	private String parseMessageHeader() {
		StringBuilder messageHeaderStringBuffer = new StringBuilder();
		try {
			Enumeration propertyNames = message.getPropertyNames();
			while (propertyNames.hasMoreElements()) {
				String propertyName = (String)propertyNames.nextElement();
				Object property = message.getObjectProperty(propertyName);
				messageHeaderStringBuffer.append(propertyName).append(": ").append(property).append("\n");
			}
		} catch (JMSException e) {
		}
